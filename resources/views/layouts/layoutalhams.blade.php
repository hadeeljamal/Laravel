...
<html lang="en">
	...
	<head><base href="">
        ...
        <link href="{{ asset('assets/css/my1.css') }}" rel="stylesheet" type="text/css" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
<!--begin::Body-->
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		<!--begin::Logo-->
		<a href="add">
				<img alt="Logo"  style="width:110px; height :120px"src="{{asset('assets/media/logos/alhams.png')}}" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<ul class="menu-nav">
							...
							<li class="menu-section">
								<h4 class="menu-text">Students Affairs</h4>
								<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
							</li>
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								<a href="add" class="menu-link menu-toggle">
							...
							<div class="topbar-item">
								<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
									...
									<span class="symbol symbol-35 symbol-light-success">
										<span class="symbol-label font-size-h5 font-weight-bold"><i class="fa fa-sign-out-alt"></i></span>
									</span>
								</div>
							</div>
							<!--end::User-->
				...
				<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Israa Hamdi & Hadeel Jamal</a>
						</div>
						<!--end::Copyright-->
	...
	<!--begin::Page Vendors(used by this page) & begin::Page Scripts(used by this page)-->
	   @yield('js')
	<!--end::Page Scripts & Page Vendors-->
</body>
<!--end::Body-->
	<!--end::Body-->
</html>
